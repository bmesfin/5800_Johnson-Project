 ...
 * hi</code> (exclusive).
 *
 * <p>The methods all take constant expected time, except those that involve arrays. The
 * <em>shuffle</em> method takes time linear in the subarray to be shuffled; the <em>discrete</em>
 * methods take time linear in the length of the argument array.
 *
